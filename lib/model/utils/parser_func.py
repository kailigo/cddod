...
def parse_args():
    ...
    parser.add_argument('--stdout_file', dest='stdout_file',
                        help='log', default="temp.log")
...
def set_dataset_args(args, test=False):
    ...
    if not test:
        ...
        # elif args.dataset == "hive":
        #     args.imdb_name = "hive_trainval"
        #     args.imdbval_name = "hive_test"
        #     args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']

        # elif args.dataset == "doc_financial_report":
        #     args.imdb_name = "doc_financial_report_trainval"
        #     args.imdbval_name = "doc_financial_report_test"
        #     args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']

        # elif args.dataset == "doc_legal":
        #     args.imdb_name = "doc_legal_trainval"
        #     args.imdbval_name = "doc_legal_test"
        #     args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.1,0.25,0.5,1,2,4,10]', 'MAX_NUM_GT_BOXES', '120']
            

        elif args.dataset == "doc_chs_median":
            args.imdb_name = "doc_chs_median_trainval"
            args.imdbval_name = "doc_chs_median_test"
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']


        elif args.dataset == "doc_med":
            args.imdb_name = "doc_med_trainval"
            args.imdbval_name = "doc_med_test"
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
        ...
        elif args.dataset_t == "pure":
            args.imdb_name_target = "pure_trainval"
            args.imdbval_name_target = "pure_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '20']


        elif args.dataset_t == "doc_chs_median":
            args.imdb_name_target = "doc_chs_median_trainval"
            args.imdbval_name_target = "doc_chs_median_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']


        elif args.dataset_t == "doc_med":
            args.imdb_name_target = "doc_med_trainval"
            args.imdbval_name_target = "doc_med_test"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
        ...
        if args.dataset == "pascal_voc":
            ...
            args.imdb_name = "doc_chs_median_trainval"
            args.imdbval_name = "doc_chs_median_trainval"
            args.set_cfgs = ['ANCHOR_SCALES', '[4, 8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
