...
__C.VGG_PATH = "./models/pretrain/vgg16_caffe.pth"

# __C.RESNET_PATH = "../models/pretrain/source_only.pth"


__C.RESNET_PATH = "./models/pretrain/resnet101_caffe.pth"
...
# __C.FPN_ANCHOR_SCALES = [32, 64, 128, 256]
# Feature stride for RPN_FPN
__C.FPN_FEAT_STRIDES = [4, 8, 16, 32, 64]
# __C.FPN_FEAT_STRIDES = [4, 8, 16, 32]
