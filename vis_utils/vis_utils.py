...
def draw_box(image_file, out_scores, out_boxes, out_classes):
...
def draw_boxes(image_files, all_boxes, classes):

    for i, image_file in enumerate(image_files):
        draw_box(image_file, out_scores, out_boxes, out_classes)
